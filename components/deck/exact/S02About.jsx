    ...
    <div style={{ position: "absolute", inset: 0, background: "#F4EFE3", overflow: "hidden", fontFamily: '"Geist", system-ui, sans-serif' }}>
      ...
      <motion.div variants={stagger} initial="hidden" animate="show" exit="exit"
        ...
        <motion.h2 variants={item}
          ...
          <span style={{ color: "#1A3320" }}>Underwrite borrowers</span><br />
        ...
        <motion.p variants={item}
          ...
          AI-native credit assessment. Kita reads messy borrower documents and turns them into decision-ready files. Live with lenders in 4 markets.
        </motion.p>
