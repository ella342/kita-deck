...
export default function U11Outcomes() {
  return (
    <div style={{ backgroundColor: '#F5F2EB', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', height: '900px', overflow: 'clip', position: 'relative', WebkitFontSmoothing: 'antialiased', width: '1440px' }}>
